...
def update_laboratorio(db: Session, laboratorio_id: int, laboratorio: schemas.LaboratorioUpdate):
    db_laboratorio = db.query(models.Laboratorio).filter(models.Laboratorio.id_laboratorio == laboratorio_id).first()
    if db_laboratorio:
